...
export async function POST(request) {
  try {
    ...
    const sitePrefix = process.env.SITE_PREFIX || 'KTR';
    const fromName = process.env.MAIL_FROM_NAME || 'Kotor Car Hire';
    const fromAddress = process.env.MAIL_FROM || 'noreply@kotorcarhire.com';
