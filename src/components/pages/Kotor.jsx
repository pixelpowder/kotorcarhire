...
export default function Kotor() {
  ...
  return (
    <ContentPage title={t("kotor.title")} subtitle={t("kotor.subtitle")} description={t("kotor.seoDesc")} image="/img/kotor-fortress.webp">
      <img src="/img/kotor-old-town.webp" alt={t('imageAlts.kotorOldTownFromFortress')} loading="lazy" />
      ...
      <img src="/img/pexels-22034286.jpg" alt={t('imageAlts.kotorFortressWalls')} loading="lazy" />
