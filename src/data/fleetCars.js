...
export const HOMEPAGE_BOOKING_CARS = [
  ...
  { slug: 'citroen-c3',           id: 68317,  name: 'Citroen C3',           category: 'Economy',   carIds: '41909,20865,68317,85926,43351,159867,74198,97133,93615,93035,85564,10740,87976,63398,96523,86323,124829,46113,96339,85093,87887', siteSlug: 'citroen-c3' },
  { slug: 'toyota-yaris',         id: 41909,  name: 'Toyota Yaris',         category: 'Economy',   carIds: '20873,9399,43329,14591,12948,88601,7010,26892,62030,53505,55075,15567,156953,20680,86364,58591,35817,35819,167691,71782,42791,59764,5014,61544,53868,83583,64497,82055,91112,68348,61546,66151,83591,91115,26317,89645,46076,46078,24485,167725,88816,49712,9456,22292,91324,65049,48734,35829,25323,25327,169021,55266', siteSlug: 'toyota-yaris' },
  { slug: 'vw-golf',              id: 9195,   name: 'VW Golf',              category: 'Compact',   carIds: '9195,23510,21508,93423,39054,21970,66195,59511,43306,165625,59621,43334,60335,85148,21183,160421,171919,76809,156551,21213,181799', siteSlug: 'vw-golf' },
  { slug: 'kia-stonic',           id: 131035, name: 'Kia Stonic',           category: 'Crossover', carIds: '131035,53626,61336', siteSlug: 'kia-stonic' },
  { slug: 'peugeot-2008',         id: 74121,  name: 'Peugeot 2008',         category: 'SUV',       carIds: '74121,61813,65386,55867,92487,62957,55869', image: '/img/fleet/peugeot-2008.jpg' },
  ...
  { slug: 'dacia-sandero',        id: 84393,  name: 'Dacia Sandero Stepway',category: 'Crossover', carIds: '9196,87870,101055,82752', image: '/img/fleet/dacia-sandero-stepway.jpg' },
